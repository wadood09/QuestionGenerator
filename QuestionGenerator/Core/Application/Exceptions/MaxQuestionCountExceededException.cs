...
namespace QuestionGenerator.Core.Application.Exceptions
{
    public class MaxQuestionCountExceededException : Exception
    {
        ...
        private static readonly string DefaultMessageStandardUser = "Standard users can only have a maximum of 20 questions per assessment.";
        private static readonly string DefaultMessagePremiumUser = "Premium users can only have a maximum of 50 questions per assessment.";
