    ...
    public class IdentityService : IIdentityService
    {
        public string GenerateToken(string key, string issuer, UserResponse user)
        {
            ...
            var claims = new List<Claim>
            {
                ...
                new Claim(JwtRegisteredClaimNames.Iat, DateTime.Now.ToString()), // Issued at
                new Claim(JwtRegisteredClaimNames.Exp, DateTime.Now.AddHours(1).ToString()), // Expiration
                new Claim(JwtRegisteredClaimNames.Aud, issuer), // Audience
